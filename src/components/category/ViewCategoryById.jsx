...
class ViewCategoryById extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    search = (event) =>{
        ...
        CategoryServiceComponent.listCategoryById(this.state.categoryId).then(res=>{
                    ...
                    <div className="col ">
                        <div className="card bg-light add-cat-card">
                            <form className="card-body">
                                ...
                                <input type="text" className="form-control" onChange={this.myChangeHandler} name="categoryId" />
                                ...
                                <div className="row ">
                                    <table className="table text-center table-striped table-hover table-bordered text-center ">
