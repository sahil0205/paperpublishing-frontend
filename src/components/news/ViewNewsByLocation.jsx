...
class ViewNewsByLocation extends Component {
    constructor(props) {
        super(props);
        this.state = {
            location: '',
    ...
    search = (event) => {
        ...
        NewsServiceComponent.listNewsByLocation(this.state.location).then(res => {
                    ...
                    <div className="col ">
                        <div className="card bg-light add-news-card">
                            <form className="card-body">
                                ...
                                <label className="form-label"> News Location </label>
                                <input type="text" className="form-control" onChange={this.myChangeHandler} name="location" />
...
export default ViewNewsByLocation;