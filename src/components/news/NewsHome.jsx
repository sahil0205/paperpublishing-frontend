...
class NewsHome extends Component {
    constructor(props) {
        ...
        this.viewByLocation = this.viewByLocation.bind(this);
    ...
    addNews(userId) {
        this.props.history.push('/addnews/' + userId);
    }

    viewNews(userId) {
        this.props.history.push('/newslist/' + userId);
    }

    viewById(userId) {
        this.props.history.push('/viewnewsbyid/' + userId);
    }

    viewByLocation(userId) {
        this.props.history.push('/viewnewsbylocation/' + userId);
    }
            ...
            <div className="login-background">
                ...
                <div className="cat-home-btn">
                    <div className="row text-center">
                        ...
                        <div className="col">
                            <button className="btn w-50 h-25 btn-primary btn-cat btn-lg" onClick={() => this.addNews(this.state.userId)}>Add News</button><br />
                            <button className="btn w-50 h-25 btn-primary cat-btn btn-lg" onClick={() => this.viewNews(this.state.userId)}>View News List</button>
                        </div>
                        <div className="col">
                            <button className="btn w-50 h-25 btn-primary btn-cat btn-lg" onClick={() => this.viewById(this.state.userId)}>View News by Id</button><br />
                            <button className="btn w-50 h-25 btn-primary cat-btn btn-lg " onClick={() => this.viewByLocation(this.state.userId)}>View News By Location</button>
                        </div>
